...
<template>
    ...
    <div
        class="flex min-h-screen flex-col items-center bg-[url('/images/background.png')] bg-cover bg-center bg-no-repeat p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[url('/images/background-dark.jpg')]"
    >
        <div class="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                >
                    ...
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]"><br />Your challenge awaits below!</p>
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            ...
                            <span>
                                ...
                                >
                                    <span>Easy Mode P&L Report</span>
                                    <svg
                                        width="{10}"
                                        height="{11}"
                                        viewBox="0 0 10 11"
                        ...
                        >
                            ...
                            <span>
                                ...
                                <Link
                                    ...
                                    class="ml-1 inline-flex items-center space-x-1 font-medium text-[#296fdc] underline underline-offset-4 dark:text-[#FF4433]"
                                >
                                    <span>Advanced Financial Challenge</span>
                                    <svg
                                        width="{10}"
                                        height="{11}"
                                        viewBox="0 0 10 11"
                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            <Link
                                href="/easy-mode"
                                class="inline-block rounded-sm bg-[#22c55e] px-5 py-1.5 text-sm leading-normal text-white hover:bg-[#16a34a] dark:bg-[#22c55e] dark:text-white dark:hover:bg-[#16a34a]"
                            >
                                📊 Easy Mode
                            </Link>
                        </li>
                ...
                >
                    <img src="/images/rocketBull.png" alt="Your image description" class="ml-10 h-full w-[calc(100%-2.5rem)] object-cover" />
                    <div class="absolute inset-0 rounded-t-lg lg:overflow-hidden lg:rounded-t-none lg:rounded-r-lg" />
                </div>
            </main>
        </div>
    </div>
